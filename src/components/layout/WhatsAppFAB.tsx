...
export default function WhatsAppFAB() {
  ...
  // Vehicle detail pages show a mobile sticky bar with its own WhatsApp CTA
  // along the bottom edge — lift the FAB above it there so they don't overlap.
  ...
  return (
    <a
      ...
      className={cn(
        "group fixed right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-success text-white shadow-fab transition-transform duration-200 hover:scale-105 active:scale-95 sm:right-6",
        hasStickyBarOnMobile ? "bottom-24 lg:bottom-6" : "bottom-5 sm:bottom-6",
      )}
    >
